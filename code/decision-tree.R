...
##############################################################################################
#predicting the maths grade level (G3) without G2. So now we have the extra information of G1
#use dataset df_maths_gl2

# Train/test split
train_indices <- sample(1:nrow(df_maths_gl2),nrow(df_maths_gl2)*0.70)
test_data <- df_maths_gl2[-train_indices2,]
# Fitting base model
...
##############################################################################################
#predicting the maths grade level (G3) without G3. So now we have the extra information of G1 and G2
